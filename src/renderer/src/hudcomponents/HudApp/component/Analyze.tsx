      ...
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="baseline" mb={1}>
          <Typography variant="h6" fontWeight={700}>
            {classesMap[stats.myClass]?.label ?? stats.myClass} 對各職業勝率
          </Typography>
        ...
        <Box mt={1.5} display="flex" gap={2} flexWrap="wrap">
          <Typography variant="caption" sx={{ opacity: 0.8 }}>
            總場數：{stats.overall.all.total}
          </Typography>
          <Typography variant="caption" sx={{ opacity: 0.8 }}>
            先攻勝率：{stats.overall.first.winRate.toFixed(1)}%
          </Typography>
          <Typography variant="caption" sx={{ opacity: 0.8 }}>
            後攻勝率：{stats.overall.second.winRate.toFixed(1)}%
          </Typography>
          <Typography variant="caption" sx={{ opacity: 0.8 }}>
            全體勝率：{stats.overall.all.winRate.toFixed(1)}%
          </Typography>
        </Box>
      </CardContent>
    </Card>
